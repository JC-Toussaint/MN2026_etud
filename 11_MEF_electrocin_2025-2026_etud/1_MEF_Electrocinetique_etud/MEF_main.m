...
%	affichage_maillage		Affichage du maillage et de la numerotation des noeuds et des �l�ments
%	solution				Calcul de la solution aux noeuds du maillage
%		integrale			Calcul des elements de la matrice elements finis
%           polynomes_S2		Dans un segment a 2 noeuds : Poids et coordonnees de Gauss / Polynomes et d�riv�es des polynomes au k point d'int�gration et au n n�ud
%           polynomes_T3		Dans un triangle a 3 noeuds : Poids et coordonnees de Gauss / Polynomes et d�riv�es des polynomes au k point d'int�gration et au n n�ud
...
%           ai_gradai_T3 : Dans un triangle a 3 noeuds : Polynomes et derivees des polynomes
